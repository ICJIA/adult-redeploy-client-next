<template>
  <v-card class="mx-auto elevation-8" color="white" style="width: 100%">
    ...
    <v-card-text>
      ...
      ></div>
      <!-- <DownloadBox :content="[...content]" header="Downloads"></DownloadBox> -->
      <div v-if="content.materials.length || content.externalURL">
        <DownloadBox :content="content" header="Links"></DownloadBox>
      </div>
